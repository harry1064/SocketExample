...
//    socket = [[SocketIOClient alloc] initWithSocketURL:url options:@{@"log": @YES,@"forceWebsockets":@(YES), @"selfSigned":@(NO)}];
...
//    [socket on:@"16" callback:^(NSArray* data, SocketAckEmitter* ack) {
//        NSLog(@"%@ %@",data,ack);
//     NSDictionary *dic =  @{@"messageid": @"123445",
//                            @"type":@"13",
//                            @"userid":primaryUser};
//        NSError *serr;
//        
...
//        [socket emit:@"13" withItems:@[textToSend]];
//        
////        NSLog(@"====%@",[data[0] valueForKey:@"hello"]);
////        JSQMessage *message = [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdJobs
////                                                 senderDisplayName:kJSQDemoAvatarDisplayNameJobs
////                                                              date:[NSDate date]
////                                                              text:[data[0] valueForKey:@"hello"]];
////       
////        
////        [self.demoData.messages addObject:message];
////        [self finishReceivingMessageAnimated:YES];
//    }];
//    [socket on:@"14" callback:^(NSArray * data , SocketAckEmitter * ack) {
//        NSLog(@"14 === %@",data);
//        NSString *users = [NSString stringWithFormat:@"%@",secondaryUser];
//        NSString *roomid = [NSString stringWithFormat:@"%@-6",primaryUser];
...
//        }
//        NSString *textToSend = [[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding];
//        [socket emit:@"17" withItems:@[textToSend]];
//    }];
//    
//    [socket on:@"18" callback:^(NSArray * data, SocketAckEmitter * ack) {
//        NSLog(@"18 === %@",data);
//
//    }];
//    [socket on:@"1" callback:^(NSArray * data, SocketAckEmitter * ack) {
//        NSLog(@"1 ======= %@",data);
//    }];
//  
